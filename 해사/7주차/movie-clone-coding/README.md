...
_(그전에 만들어뒀던 컴포넌트의 이름이나 변수명을 수정해보세요. 컴포넌트 재사용을 위해서, 포괄적인 이름을 갖도록 만드는 것이 이후 재사용이나 가독성에 좋습니다.)_

## 미션 완성본

![tv](https://github.com/UMC-SMWU/5th_UMC_Web_B/assets/34948133/d7af8b57-79a7-42fb-9b49-bf92931fcfd9)
